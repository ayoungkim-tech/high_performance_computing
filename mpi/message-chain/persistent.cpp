...
int main(int argc, char *argv[])
{
    ...
    // TODO: initialize send/request objects
    MPI_Recv_init(receiveBuffer.data(), size, MPI_INT, source, MPI_ANY_TAG, MPI_COMM_WORLD, &requests[0]);
    MPI_Send_init(message.data(), size, MPI_INT, destination, 1, MPI_COMM_WORLD, &requests[1]);
